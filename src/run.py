    ...
    if len(sys.argv) != 2:
        ...
        for q in f:
            ...
            for result in query_result:
                if(to_find=="where"):
                    if ('GPE' in result and counter<3):
        ...
        with open('output_json_file.json', 'a') as outfile:  
